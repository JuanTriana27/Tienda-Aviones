...
function createObject(Avion) {
    switch (Avion) {
        case 'MostrarAvion':
            ...
            mtlLoader.setTexturePath('/models/OBJMTL/avion1/');
            mtlLoader.setPath('/models/OBJMTL/avion1/');
            mtlLoader.load('avion1.mtl', function (materials) {
                materials.preload();

                loader.setMaterials(materials);
                loader.setPath('/models/OBJMTL/avion1/');
                loader.load('avion1.obj', function (object) {
                    object.scale.set(0.005, 0.005, 0.005);
                    object.rotation.y = 160;
                    object.rotation.x = 1.35;
                    scene.add(object);
                });
            });
            break;
